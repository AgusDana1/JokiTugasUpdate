...
<x-navbar></x-navbar>
<div class="flex flex-col md:flex-row h-auto md:h-screen mt-14">
    <main class="flex-1 p-4 md:p-8">
        <!-- Header -->
        <div class="bg-blue-400 p-10 md:p-20 rounded-lg shadow flex justify-start">
        </div>

        <!-- Profile Section -->
        <div class="mt-2 bg-white p-2 rounded-lg shadow flex flex-col md:flex-row">
            <!-- Profile Info -->
            <div class="w-full md:w-1/4 text-center p-4 border rounded-3xl bg-gradient-to-t from-blue-500 via-blue-400 to-blue-0 mb-4 md:mb-0">
                <a href="{{ route('home') }}">
                ...
                <form class="space-y-4" action="{{ route('profile.upload') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="email" name="email" class="w-full p-2 border rounded-lg bg-gray-100" value="{{ old('email', $user->email) }}" readonly>
                        </div>
                    </div>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                    ...
                    <button type="submit" class="w-full md:w-auto bg-blue-500 text-white p-2 rounded-lg hover:bg-blue-600">Update</button>
                </form>
            </div>
        </div>
    </main>
