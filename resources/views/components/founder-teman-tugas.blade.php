...
<div class="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 py-4 mt-10 w-4/5 md:w-full">
    ...
    <div class="col-span-1 shadow-lg rounded-lg relative hover:bg-blue-500 text-black hover:text-white duration-500 transition-all flex flex-col items-center gap-6 group">
        <div class="w-32 h-32 rounded-full overflow-hidden border-[10px] border-white group-hover:-top-16 group-hover:scale-105 duration-500 transition-all absolute mx-auto -top-10 bg-white">
            <img src="{{ asset('img/imgFounder/absen_33_1.JPG') }}" class="object-center object-cover h-full w-full" alt="">
        </div>
        <div class="flex flex-col gap-4 items-center mt-24">
            <p class="text-inherit text-2xl font-bold font-poppins">Agus Dana</p>
            <div class="flex gap-4 flex-col md:flex-row font-poppins text-white">
                <div class="w-fit flex justify-center items-center bg-blue-700 rounded-full py-2 px-4 text-xs font-bold">Software Engineer</div>
                <div class="w-fit flex justify-center items-center bg-blue-700 rounded-full py-2 px-4 text-xs font-bold">UI/UX</div>
                <div class="w-fit flex justify-center items-center bg-blue-700 rounded-full py-2 px-4 text-xs font-bold">Backend</div>
            </div>
            <p class="w-80 text-center text-xs md:text-md">Saya Agus Dana adalah Software Engineer sekaligus Backend Developer yang merupakan salah satu siswa dari SMKN 1 Denpasar dengan Jurusan Rekayasa Perangkat Lunak</p>
            <div class="flex gap-4 mb-10">
                <a href="https://www.instagram.com/aagusss_7?igsh=M3hvbm81Mjg3ZG44">
                ...
                <a href="https://www.tiktok.com/@gusss15_?_t=ZS-8tyuPSZCvN2&_r=1">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="currentColor" d="M16.6 5.82s.51.5 0 0A4.28 4.28 0 0 1 15.54 3h-3.09v12.4a2.59 2.59 0 0 1-2.59 2.5c-1.42 0-2.6-1.16-2.6-2.6c0-1.72 1.66-3.01 3.37-2.48V9.66c-3.45-.46-6.47 2.22-6.47 5.64c0 3.33 2.76 5.7 5.69 5.7c3.14 0 5.69-2.55 5.69-5.7V9.01a7.35 7.35 0 0 0 4.3 1.38V7.3s-1.88.09-3.24-1.48"/></svg>
                </a>

                <a href="https://github.com/AgusDana1">
    ...
    <div class="col-span-1 shadow-lg rounded-lg relative hover:bg-blue-500 text-black hover:text-white duration-500 transition-all flex flex-col items-center gap-6 group">
        <div class="w-32 h-32 rounded-full overflow-hidden border-[10px] border-white group-hover:-top-16 group-hover:scale-105 duration-500 transition-all absolute mx-auto -top-10 bg-white">
            <img src="{{ asset('img/imgFounder/absen 2.JPG') }}" class="object-center object-cover h-full w-full" alt="">
        </div>
        <div class="flex flex-col gap-4 items-center mt-24">
            <p class="text-inherit text-2xl font-bold font-poppins">Gung Jaya</p>
            <div class="flex gap-4 flex-col md:flex-row font-poppins text-white">
                <div class="w-fit flex justify-center items-center bg-blue-700 rounded-full py-2 px-4 text-xs font-bold">Network Engineer</div>
                <div class="w-fit flex justify-center items-center bg-blue-700 rounded-full py-2 px-4 text-xs font-bold">UI/UX</div>
                <div class="w-fit flex justify-center items-center bg-blue-700 rounded-full py-2 px-4 text-xs font-bold">Frontend</div>
            </div>
            <p class="w-80 text-center text-xs md:text-md">Saya Gung Jaya adalah Frontend Developer sekaligus Network Engineer yang merupakan salah satu siswa dari SMKN 1 Denpasar dengan Jurusan Rekayasa Perangkat Lunak</p>
            <div class="flex gap-4 mb-10">
                <a href="">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="currentColor" fill-rule="evenodd" d="M7.465 1.066C8.638 1.012 9.012 1 12 1s3.362.013 4.534.066s1.972.24 2.672.511c.733.277 1.398.71 1.948 1.27c.56.549.992 1.213 1.268 1.947c.272.7.458 1.5.512 2.67C22.988 8.639 23 9.013 23 12s-.013 3.362-.066 4.535c-.053 1.17-.24 1.97-.512 2.67a5.4 5.4 0 0 1-1.268 1.949c-.55.56-1.215.992-1.948 1.268c-.7.272-1.5.458-2.67.512c-1.174.054-1.548.066-4.536.066s-3.362-.013-4.535-.066c-1.17-.053-1.97-.24-2.67-.512a5.4 5.4 0 0 1-1.949-1.268a5.4 5.4 0 0 1-1.269-1.948c-.271-.7-.457-1.5-.511-2.67C1.012 15.361 1 14.987 1 12s.013-3.362.066-4.534s.24-1.972.511-2.672a5.4 5.4 0 0 1 1.27-1.948a5.4 5.4 0 0 1 1.947-1.269c.7-.271 1.5-.457 2.67-.511m8.98 1.98c-1.16-.053-1.508-.064-4.445-.064s-3.285.011-4.445.064c-1.073.049-1.655.228-2.043.379c-.513.2-.88.437-1.265.822a3.4 3.4 0 0 0-.822 1.265c-.151.388-.33.97-.379 2.043c-.053 1.16-.064 1.508-.064 4.445s.011 3.285.064 4.445c.049 1.073.228 1.655.379 2.043c.176.477.457.91.822 1.265c.355.365.788.646 1.265.822c.388.151.97.33 2.043.379c1.16.053 1.507.064 4.445.064s3.285-.011 4.445-.064c1.073-.049 1.655-.228 2.043-.379c.513-.2.88-.437 1.265-.822c.365-.355.646-.788.822-1.265c.151-.388.33-.97.379-2.043c.053-1.16.064-1.508.064-4.445s-.011-3.285-.064-4.445c-.049-1.073-.228-1.655-.379-2.043c-.2-.513-.437-.88-.822-1.265a3.4 3.4 0 0 0-1.265-.822c-.388-.151-.97-.33-2.043-.379m-5.85 12.345a3.669 3.669 0 0 0 4-5.986a3.67 3.67 0 1 0-4 5.986M8.002 8.002a5.654 5.654 0 1 1 7.996 7.996a5.654 5.654 0 0 1-7.996-7.996m10.906-.814a1.337 1.337 0 1 0-1.89-1.89a1.337 1.337 0 0 0 1.89 1.89" clip-rule="evenodd"/></svg>
                </a>
    ...
    <div class="col-span-1 shadow-lg rounded-lg relative hover:bg-blue-500 text-black hover:text-white duration-500 transition-all flex flex-col items-center gap-6 group">
        <div class="w-32 h-32 rounded-full overflow-hidden border-[10px] border-white group-hover:-top-16 group-hover:scale-105 duration-500 transition-all absolute mx-auto -top-10 bg-white">
            <img src="{{ asset('img/imgFounder/absen 15.JPG') }}" class="object-center object-cover h-full w-full" alt="">
        </div>
        <div class="flex flex-col gap-4 items-center mt-24">
            <p class="text-inherit text-2xl font-bold font-poppins">Santanu</p>
            <div class="flex gap-4 flex-col md:flex-row font-poppins text-white">
                <div class="w-fit flex justify-center items-center bg-blue-700 rounded-full py-2 px-4 text-xs font-bold">Frontend</div>
                <div class="w-fit flex justify-center items-center bg-blue-700 rounded-full py-2 px-4 text-xs font-bold">UI/UX</div>
                <div class="w-fit flex justify-center items-center bg-blue-700 rounded-full py-2 px-4 text-xs font-bold">Designer</div>
            </div>
            <p class="w-80 text-center text-xs md:text-md">Saya Santanuraga adalah Seorang Designer sekaligus Frontend Developer yang merupakan salah satu siswa dari SMKN 1 Denpasar dengan Jurusan Rekayasa Perangkat Lunak</p>
            <div class="flex gap-4 mb-10">
                <a href="">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="currentColor" fill-rule="evenodd" d="M7.465 1.066C8.638 1.012 9.012 1 12 1s3.362.013 4.534.066s1.972.24 2.672.511c.733.277 1.398.71 1.948 1.27c.56.549.992 1.213 1.268 1.947c.272.7.458 1.5.512 2.67C22.988 8.639 23 9.013 23 12s-.013 3.362-.066 4.535c-.053 1.17-.24 1.97-.512 2.67a5.4 5.4 0 0 1-1.268 1.949c-.55.56-1.215.992-1.948 1.268c-.7.272-1.5.458-2.67.512c-1.174.054-1.548.066-4.536.066s-3.362-.013-4.535-.066c-1.17-.053-1.97-.24-2.67-.512a5.4 5.4 0 0 1-1.949-1.268a5.4 5.4 0 0 1-1.269-1.948c-.271-.7-.457-1.5-.511-2.67C1.012 15.361 1 14.987 1 12s.013-3.362.066-4.534s.24-1.972.511-2.672a5.4 5.4 0 0 1 1.27-1.948a5.4 5.4 0 0 1 1.947-1.269c.7-.271 1.5-.457 2.67-.511m8.98 1.98c-1.16-.053-1.508-.064-4.445-.064s-3.285.011-4.445.064c-1.073.049-1.655.228-2.043.379c-.513.2-.88.437-1.265.822a3.4 3.4 0 0 0-.822 1.265c-.151.388-.33.97-.379 2.043c-.053 1.16-.064 1.508-.064 4.445s.011 3.285.064 4.445c.049 1.073.228 1.655.379 2.043c.176.477.457.91.822 1.265c.355.365.788.646 1.265.822c.388.151.97.33 2.043.379c1.16.053 1.507.064 4.445.064s3.285-.011 4.445-.064c1.073-.049 1.655-.228 2.043-.379c.513-.2.88-.437 1.265-.822c.365-.355.646-.788.822-1.265c.151-.388.33-.97.379-2.043c.053-1.16.064-1.508.064-4.445s-.011-3.285-.064-4.445c-.049-1.073-.228-1.655-.379-2.043c-.2-.513-.437-.88-.822-1.265a3.4 3.4 0 0 0-1.265-.822c-.388-.151-.97-.33-2.043-.379m-5.85 12.345a3.669 3.669 0 0 0 4-5.986a3.67 3.67 0 1 0-4 5.986M8.002 8.002a5.654 5.654 0 1 1 7.996 7.996a5.654 5.654 0 0 1-7.996-7.996m10.906-.814a1.337 1.337 0 1 0-1.89-1.89a1.337 1.337 0 0 0 1.89 1.89" clip-rule="evenodd"/></svg>
                </a>
