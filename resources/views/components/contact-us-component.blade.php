<div class="mt-20 w-full p-2 md:p-8 flex flex-col items-center bg-white">
    ...
    <section class="py-2 px-2 bg-blue-100 rounded-lg drop-shadow-lg">
      <div class="w-full mx-auto bg-white p-8 rounded-lg shadow-lg"> 
        <h1 class="text-xl font-bold font-poppins text-blue-700 mb-5">Berikan Feedback Untuk Website Kami</h1>
        ...
        <div class="flex flex-col md:flex-row gap-8">
          ...
          <div class="w-full md:h-1/2">
            <form action="{{ route('send.feedback') }}" method="POST" class="space-y-4">
              ...
              <button type="submit" class="w-full bg-blue-600 text-white font-semibold py-2 rounded-md hover:bg-blue-700 transition-all">Kirim Feedback</button>
            </form>
          </div>
