    ...
    <div>
            ...
            <table class="w-full border-collapse border border-gray-300 bg-white shadow-md hidden md:table">
                ...
                <tbody>
                    ...
                    <tr class="text-center border-b">
                        ...
                        <td class="border p-3">
                            <a href="{{ route('order.show', $order->id) }}" class="bg-blue-500 text-white font-medium px-4 py-2 rounded-md transition-all hover:bg-blue-800">Detail</a>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
        ...
        <div class="md:hidden space-y-4">
            ...
            <div class="bg-white shadow-md rounded-lg p-4 border">
                ...
                <div class="mt-2">
                    <a href="{{ route('order.show', $order->id) }}" class="bg-blue-500 w-1/3 text-white px-4 py-2 rounded-md font-medium block text-center transition-all hover:bg-blue-800">Detail</a>
                </div>
            </div>
            @endforeach
        </div>
